		  ...
		  float size)
{
    ...
    const Vector4f v0( 1.0f,  1.0f, -1.0f);
    const Vector4f v1(-1.0f,  1.0f, -1.0f);
    const Vector4f v2( 1.0f,  1.0f,  1.0f);
    const Vector4f v3(-1.0f,  1.0f,  1.0f);
    const Vector4f v4( 1.0f, -1.0f, -1.0f);
    const Vector4f v5(-1.0f, -1.0f, -1.0f);
    const Vector4f v6( 1.0f, -1.0f,  1.0f);
    const Vector4f v7(-1.0f, -1.0f,  1.0f);
